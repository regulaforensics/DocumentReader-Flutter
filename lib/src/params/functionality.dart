...
class Functionality {
  ...
  ///
  /// Default: 5.
  int? get showCaptureButtonDelayFromDetect => _showCaptureButtonDelayFromDetect;
  ...
  /// Android only.
  double? get videoRecordingSizeDownscaleFactor => _videoRecordingSizeDownscaleFactor;
