...
enum VisualFieldType {
  ...
  const VisualFieldType(this.value);
  final int value;
  ...
  static VisualFieldType? getByValue(int? i) {
    if (i == null) return null;
    try {
      return VisualFieldType.values.firstWhere((x) => x.value == i);
    } catch (_) {
      return VisualFieldType.UNKNOWN;
    }
  }
